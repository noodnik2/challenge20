...
def packed_meetings(meetings_list):
    ...
    for meeting in ordered_meeting_set:
        ...
        for attendee in meeting:
            ...
            if attendee_meeting_count_dict[attendee] > 1:
                meeting_double_booked_count += 1
    ...
    meetings_list_sortkey = lambda meeting: (meeting_double_booked_count_dict[tuple(meeting)] - len(meeting), -len(meeting), meeting)
