...
public class NewYearChaos {
	...
	public void testSolution4() {
		assertAllTestCases(new MinBribeCalcTry4());
	}
	
	@Test
	public void testSolution3() {
		assertAllTestCases(new MinBribeCalcTry3());
	}
	
	@Test
	public void testSolution2() {
		assertAllTestCases(new MinBribeCalcTry2());
	}
	
	@Test
	public void testSolution1() {
		assertAllTestCases(new MinBribeCalcTry1());
	}
	
	void assertAllTestCases(MinBribeCalculator mbc) {
	...
	static class MinBribeCalcTry4 implements MinBribeCalculator {

		//
		// Kudos to https://www.hackerrank.com/lsming
		//
		// logic:
		//   starting at end going backwards;
		//   count bribes that must have taken place (per rules)
		//     in order to get person where they are in line
		//     (i.e., label less than person in front now)
		//   
